        ...
        <div id="create-annonce" class="content scaffold-create" role="main">
            ...
            <form action="save" method="POST" enctype="multipart/form-data">
                ...
                <fieldset class="form">
                    ...
                    <div class="fieldcontain required">
                        <label>Télécharger illustration
                            <span class="required-indicator">*</span>
                        </label>
                        <input type="file" name="file" id="file" value="fileToUpload" accept="image/png, image/jpeg, image/jpg"/>
                    </div>
                    ...
                    <g:select name="author" from="${grailstp.User.list().id}" value="value">
                    </g:select>
                </div>
                </fieldset>
                <fieldset class="buttons">
                    <input class="save" type="submit" value="${message(code: 'default.button.save.label', default: 'Create')}" />
                </fieldset>
            </form>
        </div>
    </body>
