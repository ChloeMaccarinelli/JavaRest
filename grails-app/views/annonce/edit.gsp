            ...
            <g:form resource="${this.annonce}" method="PUT">
                ...
                <fieldset class="form">
                    ...
                    <label for="illustration">Illustration
                        ...
                        <img style="height: 50px; width : 50px" src="../../assets/${annonce.illustration.filename}"/>
                </div>
                    <div class="fieldcontain">
                    <label for="illustrations">Illustrations</label>
                        <!--<g:each in="${grailstp.Illustration.count()?1..(grailstp.Illustration.count() as Integer):[]}" var="value" >
                            <img src="../../assets/${grailstp.Illustration.get(value).filename}"/>
                            <br/>
                        </g:each>-->

                        <g:each in="${annonce.illustrations}" var="value" >
                            <div style="display: inline-block">
                            <img style="width: 50px;height: 50px" src="../../assets/${value.filename}"/>
                            </div>
                        </g:each>
                        <br/><br/>
                        &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
                        <g:select name="selectIllustration" id="selectIllustration" from="${grailstp.Illustration.list().filename}" value="value">
                        </g:select>
                        <g:link controller="annonce" action="addIllustration" data-illustration="">
                            <button id="addillu" type="button" class="save">Add illustration</button>
                        </g:link>

                        <a href="/illustration/create?annonce.id=${annonce.id}">Add new illustration</a>
                </div>
                    <div class="fieldcontain">
                    ...
                    <g:select name="selectAuthor" from="${grailstp.User.list().username}" value="value">
                    </g:select>
                </div>
                </fieldset>
