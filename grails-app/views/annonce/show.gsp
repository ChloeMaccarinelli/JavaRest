        ...
        <div id="show-annonce" class="content scaffold-show" role="main">
            ...
            <ol class="property-list annonce">
                ...
                <li class="fieldcontain">
                    ...
                    <div class="property-value" aria-labelledby="illustration-label"><a href="/illustration/show/${annonce.id}"><img style="width : 50px; height : 50px" src="../../assets/${annonce.illustration.filename}"/></a></div>
                </li>
                    ...
                    <g:each in="${annonce.illustrations}" var="value">
                        <div style="display: inline-block">
                            <div class="property-value" aria-labelledby="illustration-label">
                                <a href="/illustration/show/${value.id}">
                                    <div style="margin : 5px; width : 50px; height: 50px; border: dashed 1px black">
                                        <img width="100%" height="100%" src="../../assets/${value.filename}"/>
                                    </div>
                                </a>
                            </div>
                        </div>
                ...
                <li class="fieldcontain">
                    ...
                    <div class="property-value" aria-labelledby="author-label"><a href="/user/show/${annonce.author.id}">${annonce.author.username}</a></div>
                </li>
