...
<html>
    ...
    <body>
        ...
        <div id="create-illustration" class="content scaffold-create" role="main">
            ...
            <g:uploadForm name="uploadFearturedImage" resource="${this.illustration}" method="POST">
                <fieldset class="form">
                    ...
                    <input type="file" name="fileToUpload" id="fileToUpload" value="fileToUpload" accept="image/png, image/jpeg, image/jpg"/>
                    </div>

                </fieldset>
                <fieldset class="buttons">
                    <g:submitButton name="create" class="save" value="${message(code: 'default.button.create.label', default: 'Upload')}" />
                </fieldset>
            </g:uploadForm>
        </div>
    </body>
