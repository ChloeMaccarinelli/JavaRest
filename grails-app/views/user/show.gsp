            ...
            <ol class="property-list user">
                ...
                <li class="fieldcontain">
                    ...
                    <div class="property-value" aria-labelledby="thumbnail-label">
                        <a href="/illustration/show/17">
                            <img style="width : 50px; height : 50px" src="../../assets/${user.thumbnail.filename}"/>
                        </a>
                    </div>
                </li>

                <div class="fieldcontain">
                    <label>Annonces</label><a href="/annonce/create?user.id=">Add Annonce</a>
                </div>
            </ol>
